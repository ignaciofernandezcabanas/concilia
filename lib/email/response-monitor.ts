...
export async function checkInquiryResponses(
  ...
  // ── Clarification replies handled via Inquiry system (Phase A below) ──
  // REQUEST_CLARIFICATION in resolver creates a linked Inquiry.
  // Response detection uses the same Inquiry pipeline — no separate phase needed.
