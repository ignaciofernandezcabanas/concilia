...
describe('findExactMatch', () => {
  ...
  it('múltiples candidatos → ordenados por confidence descendente', async () => {
    const contact = buildContact();
    const inv1 = buildInvoice({ id: 'inv_1', issueDate: new Date('2026-03-01'), totalAmount: 1000, type: 'RECEIVED', contact });
    const inv2 = buildInvoice({ id: 'inv_2', issueDate: new Date('2026-03-14'), totalAmount: 1000, type: 'RECEIVED', contact });
