...
const PYG_STRUCTURE: PyGLine[] = [
  ...
  { code: '11', label: 'Deterioro y resultado enajenaciones', accountRange: '690-699,770-779', sign: 1 },
  ...
  { code: '14', label: 'Variaciones valor razonable instrumentos financieros', accountRange: '663,763', sign: 1 },
  { code: '15', label: 'Diferencias de cambio', accountRange: '668,768', sign: 1 },
  { code: '16', label: 'Deterioro y resultado enajenaciones financieras', accountRange: '696-699,796-799', sign: 1 },
