  ...
  try {
    ...
    const company = await prisma.company.findUnique({
      ...
      include: {
        ...
        subsidiaries: { select: { id: true, name: true, shortName: true, consolidationMethod: true, ownershipPercentage: true } },
        _count: { select: { bankTransactions: true, invoices: true, users: true, journalEntries: true } },
      },
    });
...
export const PUT = withAuth(async (
  ...
  try {
    ...
    if (data.presentationCurrency !== undefined) update.presentationCurrency = data.presentationCurrency;
    if (data.parentCompanyId !== undefined) update.parentCompanyId = data.parentCompanyId;
    if (data.consolidationMethod !== undefined) update.consolidationMethod = data.consolidationMethod;
    if (data.ownershipPercentage !== undefined) update.ownershipPercentage = data.ownershipPercentage;
    ...
    if (data.firstConsolidationPeriod !== undefined) update.firstConsolidationPeriod = data.firstConsolidationPeriod;
