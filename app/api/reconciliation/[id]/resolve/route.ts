...
export const POST = withAuth(
  async (req: NextRequest, ctx: AuthContext & { params?: Record<string, string> }) => {
    ...
    const payload: ResolvePayload = {
      ...
      reconciliationId: "reconciliationId" in input ? input.reconciliationId : reconciliationId,
      bankTransactionId: "bankTransactionId" in input ? input.bankTransactionId : undefined,
      ...
      differenceReason:
        "differenceReason" in input
          ...
          : undefined,
      differenceAccountId: "differenceAccountId" in input ? input.differenceAccountId : undefined,
      ...
      duplicateOfId: "duplicateOfId" in input ? input.duplicateOfId : undefined,
      duplicateGroupId: "duplicateGroupId" in input ? input.duplicateGroupId : undefined,
